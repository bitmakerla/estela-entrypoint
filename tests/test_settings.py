...
def test_populate_settings(mock_load_default_settings, mock_update_deprecated_classpaths):
...
def test_update_deprecated_classpaths():
    test_settings = Settings()
    test_settings.get('EXTENSIONS').update({'scrapy.telnet.test':100}) #deprecated path
